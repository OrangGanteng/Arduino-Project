...
#define REST 0  
 // ganti tempo menjadi cepat atau lambat
 int tempo1 = 140;  
 int tempo2 = 180;  
 int tempo3 = 140;  
...
void setup() {  
  Serial.begin(9600);  
  Serial.println("Selamat Datang di Arduino Melody");  
  Serial.println("Tekan Atas untuk memainkan melodi HAPPY BIRTHDAY");  
  Serial.println("Tekan Tengah untuk memainkan melodi NOKIA");  
  Serial.println("Tekan Bawah untuk memainkan melodi Merry CHRISTMAS");  
}
...
void loop(){  
  if( Serial.available() > 0){  
    ...
    switch (value){  
      case 'atas':
        Serial.println("MULAI MEMAINKAN MELODI HAPPY BIRTHDAY ");  
      ...
      break;  
    case 'tengah':  
      Serial.println("MULAI MEMAINKAN MELODI NOKIA ");    
    ...
    break;  
    case 'bawah':  
      Serial.println("MULAI MEMAINKAN MELODI MERRY CHRISTMAS");  
